...
BrowserDetect.init();
(function() {
  var browser_name, comp_view_status, cookies_status, flash_version, java_versions, os_name, pdf_reader, popup_blocker_status, user_agent_string, zoom_level;
  ...
  popup_blocker_status = function() {
    var popup, popups, timeout;
  ...
  $(document).ready(function() {
    var browser, comp_view, cookies, flash, java, os, pdf, popup_blocker, resolution, uas, zoom;
