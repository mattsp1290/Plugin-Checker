...
BrowserDetect.init();
(function() {
  var getBrowser, getCompView, getCookies, getFlash, getJava, getOSName, getPDFReader, getPopUpBlockerStatus, getUAS, getZoomLevel;
  ...
  getPopUpBlockerStatus = function() {
  ...
  $(document).ready(function() {
    var compHTML, resolution, zoomHTML;
    ...
    if (/Internet\sExplorer/.test(getBrowser())) {
      ...
      return $('#check_comp').val(getCompView());
    }
  });
