...
(function() {
  $(document).ready(function() {
    var OSName, app, clip, comp, compView, cookies, copyButton, functionRan, ie, info, match, popup, screen, tem, ua, zoom, zoomLevel;
    ...
    if (FlashDetect.raw) {
      ...
      clip.addEventListener('mousedown', function() {
        return clip.setText('Hello World');
      });
      clip.addEventListener('complete', function(client, text) {
        return alert('copied: ' + text);
      });
      return clip.glue(document.getElementById('copy'));
    }
  });
