...
BrowserDetect.init();
(function() {
  var getBrowser, getOSName, getUAS;
  ...
  $(document).ready(function() {
    var comp, compView, cookies, flash, ie, info, java, popup, popups, resolution, screen, zoom, zoomLevel;
    ...
    setTimeout(function() {
      if (!popup || popup.outerHeight === 0) {
        ...
        return $('#popup-result').html('enabled');
      } else {
        popup.close();
        popups = 'disabled';
        $('#check_popups').val('disabled');
        return $('#popup-result').html('disabled');
      }
    }, 25);
    ...
    return console.log(/Firefox/.test(getBrowser()));
  });
